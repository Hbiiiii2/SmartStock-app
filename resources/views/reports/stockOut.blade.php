            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6 bg-gray-50 p-4 rounded-lg">
                        <form action="{{ route('reports.stockOut') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($stockOuts as $stockOut)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $stockOut->product->category->name }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $stockOut->quantity }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">Rp {{ number_format($stockOut->price_per_unit, 0, ',', '.') }}</td>
