                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('stock-in.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="mb-4">
                                <label for="received_at" class="block text-gray-700 text-sm font-bold mb-2">Date</label>
                                <input type="date" name="received_at" id="received_at" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('received_at', date('Y-m-d')) }}" required>
                                @error('received_at')
                        ...
                        <div class="flex items-center justify-between mt-6">
                            <a href="{{ route('stock-in.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                Back
                            </a>
