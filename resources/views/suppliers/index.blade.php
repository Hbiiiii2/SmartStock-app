                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody>
                                @foreach($suppliers as $supplier)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap border-b border-gray-300">{{ $supplier->name }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap border-b border-gray-300">{{ $supplier->email }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap border-b border-gray-300">{{ $supplier->phone }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap border-b border-gray-300">{{ $supplier->address }}</td>
