            ...
            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 overflow-hidden shadow-xl sm:rounded-lg mb-6">
                <div class="p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-xl font-bold">Welcome to SmartStock</h3>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <a href="#" class="flex items-center p-3 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors duration-150">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-yellow-900">Generate Report</p>
                                    <p class="text-xs text-yellow-500">Create inventory reports</p>
                                </div>
                            </a>
                        </div>
